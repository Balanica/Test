...
//Avocat_Oficiu::Avocat_Oficiu(Avocat *pAvocat) {
//    nume = pAvocat->getNume();
//    cod = pAvocat ->getCod();
//    nr_procese = pAvocat ->getNr_procese();
//    for(int i = 0; i < pAvocat->getNr_procese();i++)
//        vector_procese[i] = pAvocat->getVector_procese()[i];
//}
